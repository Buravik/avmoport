<?php /* Smarty version 2.6.5-dev, created on 2018-04-03 22:07:44
...
<div class="topDiv">
	...
	<div class="rightColumnTop">&nbsp;
		...
		<div class="ToolBox">
		<b><?php echo $this->_tpl_vars['EmpName']; ?>
</b>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="settings.php" target="mainframe"><?php echo $this->_tpl_vars['Lang']['SETTINGS']; ?>
</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php"><?php echo $this->_tpl_vars['Lang']['EXIT']; ?>
</a>
		</div>
		<div class="InfoBox">
		...
		<ul class="board">
			<li style="width:50%">
			<!--<span class="title" id="Title1">Агент:&nbsp;</span><span id="CodeSpan"><?php echo $this->_tpl_vars['AgentInfo']['company']; ?>
</span>!-->
			</li>
			<li style="width:50%">
			<!--<span class="title" id="Title2">Масъул шахс:&nbsp;</span><span id="NameSpan"><?php echo $this->_tpl_vars['AgentInfo']['name']; ?>
</span>!-->
			</li>
		</ul>
